...
char *device_secret     = "bIP6G5epJtHuOYvuVcFaTN53wJK6hvlO";
...
void demo_download_recv_handler(void *handle, int32_t percent, const aiot_download_recv_t *packet, void *userdata)
{
